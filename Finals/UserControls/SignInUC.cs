...
namespace Finals.UserControls
{
    public partial class SignInUC : UserControl
    {
        ...
        {
            if (!SignPanel.Controls.Contains(UserControls.SignUpUC.Instance))
            {
                SignPanel.Controls.Add(UserControls.SignUpUC.Instance);
                UserControls.SignUpUC.Instance.Dock = DockStyle.Fill;
